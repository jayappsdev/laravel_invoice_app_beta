        ...
        <div class="card__content">
            <div class="card__content--header">
                <div>
                    ...
                    <select name="" id="" class="input" v-model="customer_name">
                        <option disabled>Select customer</option>
                        <option :value="customer.firstname" v-for="customer in allcustomers" :key="customer.id">
                            {{ customer.firstname }}
                        </option>
                    </select>
                </div>
        ...
        <div class="modal__content">
            ...
            <div class="modal__items">
                <ul style="list-style: none">
                    <li v-for="(item, i) in listproducts" :key="item.id" style="display: grid;grid-template-columns: 30px 350px 15px;padding-bottom: 5px;">
                        <p>{{ i+1 }}</p>
